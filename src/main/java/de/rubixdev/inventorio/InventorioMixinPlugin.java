...
public final class InventorioMixinPlugin implements IMixinConfigPlugin {
    private static final String ROOT_PACKAGE = "de.rubixdev.inventorio.mixin.";
    private static final String OPTIONAL_PACKAGE_ENDERCHEST = "de.rubixdev.inventorio.mixin.optional.enderchest.";
    private static final String OPTIONAL_PACKAGE_BOWFIX = "de.rubixdev.inventorio.mixin.optional.bowfix.";
    private static final String OPTIONAL_PACKAGE_TOTEM = "de.rubixdev.inventorio.mixin.optional.totem.";

    @Override
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        if (!mixinClassName.startsWith(ROOT_PACKAGE)) return false;

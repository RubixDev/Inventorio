...
abstract class AbstractInventorioScreen protected constructor(handler: InventorioScreenHandler, inventory: PlayerInventory) :
    ...
    companion object {
        ...
        private val initConsumers = mutableMapOf<Identifier, Consumer<AbstractInventorioScreen>>()
